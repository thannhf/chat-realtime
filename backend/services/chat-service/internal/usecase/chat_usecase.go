...
func (u *chatUsecase) GetChatHistory(ctx context.Context, conversationID uint64, userID uuid.UUID, lastMessageID *uint64, limit int) ([]domain.Message, error) {
	...
	return u.msgRepo.GetChatHistory(ctx, conversationID, lastMessageID, limit)
}
